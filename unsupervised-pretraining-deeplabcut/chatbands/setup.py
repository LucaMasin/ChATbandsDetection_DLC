...
make_labeled_tif.get_slice_results(os.path.join(chatbands_path, "00629_2R_C01_chAT_STD.tif"), os.path.join(dest_path, "video00629_2R_C01_50DeepCut_resnet50_chATbandsMay22shuffle1_71000.h5"), chatbands_path, step_size=50)
